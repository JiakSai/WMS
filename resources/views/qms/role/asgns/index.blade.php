    ...
    <div class="d-flex">
        <div class="ms-auto mb-3">
            ...
            <div class="input-group flex-nowrap">
                <input type="text" class="form-control text-uppercase" name="name" placeholder="Full Name / Employee ID" autofocus />
...
<script>
    ...
    $(document).ready(function() {
        ...
        mainDataTable = $('#mainDataTable').DataTable({
                    ...
                    buttons: [{
                        ...
                        'spacer', 'spacer',
                        {
                            ...
                            action: function(e, dt, node, config) {
                                $('#modal').modal('show');
                                modal('{{ route('qms.role.asgns.create', ['organisation' => $organisation->id]) }}',
                                    2);
                            }
                        }
                    ]
            ...
            ajax: {
                method: "POST",
                url: '{{ route('qms.role.asgns.show', ['organisation' => $organisation->id]) }}',
                data: function(d) {
                    d._token = '{{ csrf_token() }}';
            ...
            columns: [
                {
                    // Use a custom render function to show the count of rows
                    data: null, // No data source
                    render: function(data, type, row, meta) {
                        // meta.row gives you the index of the row, +1 to start count from 1
                ...
                },
                {
                    ...
                    mRender: function(data, type, row) {
                        ...
                        +'<li><a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal" onclick="modal(\'' + '{{ route('qms.role.asgns.edit', ['organisation' => $organisation->id]) }}' + '\', \'' + username + '\')"><i class="bi bi-pencil-square"></i> Edit</a></li>' 
