...
<script>
    ...
    $(document).ready(function() {
        ...
        permDataTable = $('#permDataTable').DataTable({
            ...
            "ajax": {
                method: "POST",
                url: '{{ route('wms.role.perms.show', ['organisation' => $organisation->id]) }}',
                data: function(d) {
                    d._token = '{{ csrf_token() }}';
            ...
            'columns': [
                ...
                { 'data' : 'updated_by'},
                {
                    mRender: function (data, type, row) {
                        ...
                        +'<a href="#" class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#modal" onclick="modal(\'' + '{{ route('wms.role.perms.create', ['organisation' => $organisation->id]) }}' + '\', \'' + id + '\')"><i class="bi bi-plus-circle"></i> Assign Role</a>'
                        +'</ul>'    
                        +'</div></center>';
                    },
                },
