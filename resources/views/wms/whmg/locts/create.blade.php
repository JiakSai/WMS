<div class="modal-header">
    <h1 class="modal-title fs-5" id="exampleModalLabel">Location Name</h1>
    ...
    <div class="modal-body" style="max-height: calc(100vh - 200px);overflow-y: auto;">
        <div class="mb-3 row" id="formContent">
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select class="form-select" name="warehouse" autofocus>
...
<script>
    $("#addForm").submit(function(event) {
        ...
        $.ajax({
            method: "POST",
            url: '{{ route('wms.whmg.locts.store', ['organisation' => $organisation->id]) }}',
            data: formData,
            success: function(d) {
                // Hide the spinner
