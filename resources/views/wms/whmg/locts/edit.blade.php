<div class="modal-header">
    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Warehouse Location</h1>
...
<form id="addForm">
    <div class="modal-body" style="max-height: calc(100vh - 200px);overflow-y: auto;">
        <div class="mb-3 row" id="formContent">
            ...
            <div class="row mb-3">
                <label class="col-sm-3 col-form-label" autofocus>Location Name</label>
                <div class="col-sm-9">
...
<script>
    $("#addForm").submit(function(event) {
        ...
        $.ajax({
            method: "POST",
            url: '{{ route('wms.whmg.locts.update', ['organisation' => $organisation->id]) }}',
            data: formData,
            success: function(d) {
                // Hide the spinner
