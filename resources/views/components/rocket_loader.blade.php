                                    ...
                                    <div class="row gx-2">
                                            <div class="col-6">
                                                    <a href="javascript:;" data-toggle="theme-mode-selector"
                                                            ...
                                                            <div class="img"><img src="{{asset('img/mode/dark.jpg')}}"
                                                                            class="object-fit-cover" height="76"
                                                                            width="76" alt="Dark Mode"></div>
                                            ...
                                            <div class="col-6">
                                                    <a href="javascript:;" data-toggle="theme-mode-selector"
                                                            ...
                                                            <div class="img"><img src="{{asset('img/mode/light.jpg')}}"
                                                                            class="object-fit-cover" height="76"
                                                                            width="76" alt="Light Mode"></div>
                                    ...
                                    <div class="app-theme-cover">
                                            <div class="app-theme-cover-item active">
                                                    <a href="javascript:;" class="app-theme-cover-link"
                                                            style="background-image: url('{{asset('img/cover/cover-thumb-1.jpg')}}');"
                                            ...
                                            <div class="app-theme-cover-item">
                                                    <a href="javascript:;" class="app-theme-cover-link"
                                                            style="background-image: url('{{asset('img/cover/cover-thumb-2.jpg')}}');"
...
<script src="{{asset('js/rocket-loader.min.js')}}" data-cf-settings="75585ce28ba806737c24d4bd-|49" defer=""></script>