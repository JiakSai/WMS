...
<div id="header" class="app-header">
    ...
    <div class="brand w-50">
        <a href="{{ route('home', ['organisation' => $org->id]) }}" class="brand-logo">
            <span class="brand-img">
                <span class="brand-img-text text-theme"><i class="bi bi-heart text-danger"></i></span>
            </span>
            <span class="brand-text">WMS &#91; {{ $org->name }} &#93;</span>
        </a>
    </div>
        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                <div class="menu-img online">
                    <img src="{{asset('/img/user/user.png')}}" alt="Profile" height="60" />
                </div>
            ...
            <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                ...
                <a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#modal" href="#" onclick="modal('{{ route('change.organisation') }}', 0)">ORGANISATIONS<i
                    class="bi bi-arrow-left-right ms-auto text-theme fs-16px my-n1"></i></a>
