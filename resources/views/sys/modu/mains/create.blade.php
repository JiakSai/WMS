...
<div class="modal-header">
    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Main Module</h1>
    ...
    <div class="modal-body">
        <div class="mb-3 row">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control text-lowercase" name="code" minlength="3" maxlength="3"> 
                </div>
            </div>
...
<script>
    ...
    $("#addForm").submit(function(event) {
        ...
        // Convert the Main Module Code to uppercase
        let codeInput = $(this).find('input[name="code"]');
        codeInput.val(codeInput.val().toLowerCase());
        ...
        $.ajax({
            method: "POST",
            url: '{{ route('sys.modu.mains.store', ['organisation' => $organisation->id]) }}',
            data: formData,
            success: function(d) {
