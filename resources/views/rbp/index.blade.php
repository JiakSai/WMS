...
@section('title', " $main->name Role Authorization Management")

@section('content')
    <div class="d-flex align-items-center mb-3">
        <div class="p-2 flex-fill"> <h1 class="page-header mb-0">{{ $main->name }} Role Authorization Management</h1></div>
        <div class="ms-auto p-2 ">
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home', ['organisation' => $organisation])}}">SMTT</a></li>
                <li class="breadcrumb-item">{{ $main->name }} Role Authorization Management</li>
            </ul>
        </div>
    </div>
    <div class="row gx-4">
