...
<div class="modal-header">
    <h1 class="modal-title fs-5" id="exampleModalLabel">Create New Group Level</h1>
...
<form id="addForm" method="POST">
    ...
    <div class="modal-body" style="max-height: calc(100vh - 200px); overflow-y: auto;">
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <select id="group_name" name="group" class="form-select">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#addForm").submit(function(event) {
            ...
            $.ajax({
                method: "POST",
                url: '{{ route('mrb.lvlc.galls.store', ['organisation' => $organisation->id]) }}',
                data: formData,
                success: function(d) {
                    // Hide the spinner
