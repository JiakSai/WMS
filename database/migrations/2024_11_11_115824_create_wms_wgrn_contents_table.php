...
return new class extends Migration
{
    ...
    {
        Schema::create('wms_wgrn_contents', function (Blueprint $table) {
            $table->id()->comment('GRN Content ID');
            $table->unsignedBigInteger('wgrn_header_id')->comment('GRN Header ID');
    ...
    {
        Schema::dropIfExists('wms_wgrn_contents');
    }
};
