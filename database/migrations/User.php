...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('username', 255)->unique()->comment('Username/Employer ID');
            ...
            $table->string('name', 200)->nullable()->comment('Name');
            $table->string('ticket', 255)->nullable()->comment('Ticket/Token');
            $table->integer('telegram_id')->nullable()->comment('Telegram ID');
            $table->unsignedBigInteger('default_warehouse')->comment('Default Warehouse');
